<?php if ( ! defined('ACCESS_OK')) exit('Can\'t access scripts directly!');
	...
	class Frame
	{
		...
		public function _runTo( $findSection=null, $skips=0 )
		{
            ...
            // Is this safe? - October 29th 2010
            // If no errors found within a month or two, just remove these comments
//			$this->currentSection = $lastSection;
		 ...
		 * @param params An array of parameters for the view.
		 */
		public function view( $section, $view, $params=null )
		{
			$this->_runTo( $section );
		 ...
		 * @param params Optional array of variables to set within the view.
		 */
		public function pre( $section, $view, $params=null )
		{
			$this->_runTo( $section );
			$this->controller->__viewInner( $view, $params );
		}
		 ...
		 * @param params Optional array of variables to set within the view.
		 */
		public function post( $section, $view, $params=null )
		{
		 ...
		 */
		public function text( $section, $text )
		{
			$this->_runTo( $section );
			// don't view this in the future
			$this->views[$section] = null;
		 ...
		 * @param text The text to echo.
		 */
		public function preText( $section, $text )
		{
			$this->_runTo( $section );
			echo $text;
		}
		 ...
		 * @param text The text to echo.
		 */
		public function postText( $section, $text )
		{
			$this->_runTo( $section, 1 );
			echo $text;
		}
